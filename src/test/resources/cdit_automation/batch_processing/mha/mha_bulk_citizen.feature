...
Feature: Data processing for MHA bulk citizen file
  ...
  Scenario: Datasource service processes a MHA bulk citizen file
    ...
    | Singaporean,M,DoD:DeathBeforeBirth,MHAAddress,BuildingName:123113afweaafawe aefa121,UnitNo:12,BlkNo:212,StrtName:faea eae,FlrNo:12,Quantity:1        |
    | PermanentResident,F,DoD:DeathBeforeBirth,Overseas,BlkNo:212,StrtName:faea eae,FlrNo:12,BuildingName:123113afweaafawe aefa121,mhaAddrType:A,Quantity:1|
