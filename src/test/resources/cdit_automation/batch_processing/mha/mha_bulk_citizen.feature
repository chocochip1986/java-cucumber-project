...
Feature: Data processing for MHA bulk citizen file
  ...
  Scenario: Datasource service processes a MHA bulk citizen file
    ...
    | Singaporean,F,Nric:S2332928Z,Name:Bak Chor Mee,MHAAddress,PostalCode:123456,BuildingName:Shenton way,UnitNo:12,BlkNo:212,StrtName:Kfc street,FlrNo:12,Quantity:1       |
