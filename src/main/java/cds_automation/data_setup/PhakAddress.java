package cds_automation.data_setup;

import cds_automation.data_setup.data_setup_address.PhakAbstractAddress;
import cds_automation.data_setup.data_setup_address.PhakCondoAddress;
import cds_automation.data_setup.data_setup_address.PhakExecCondoAddress;
import cds_automation.data_setup.data_setup_address.PhakHdbAddress;
import cds_automation.data_setup.data_setup_address.PhakHospitalAddress;
import cds_automation.data_setup.data_setup_address.PhakIslandAddress;
import cds_automation.data_setup.data_setup_address.PhakKampongAddress;
import cds_automation.data_setup.data_setup_address.PhakLandedAddress;
import cds_automation.data_setup.data_setup_address.PhakLorongBuangkokAddress;
import cds_automation.data_setup.data_setup_address.PhakNursingAddress;
import cds_automation.data_setup.data_setup_address.PhakOrphanageAddress;
import cds_automation.data_setup.data_setup_address.PhakPrisonAddress;
import cds_automation.enums.automation.PropertyTypeEnum;
...
public class PhakAddress {
    ...
    public static PhakAbstractAddress suggestAnAddress(PropertyTypeEnum propertyTypeEnum) {
        switch (propertyTypeEnum) {
            ...
            case LORONG_BUANGKOK:
                return PhakLorongBuangkokAddress.fakeItTillYouMakeIt();
            case LANDED:
