...
public class MhaOverseasFileEntry extends AddressFileEntry {
    ...
    public MhaOverseasFileEntry(String unitNo, String floorNo, String blockNo, String streetName, String buildingName, String oldPostalCode, String postalCode, String addressType) {
        this.unitNo = unitNo == null ? EMPTY_STRING : unitNo;
        this.floorNo = floorNo == null ? EMPTY_STRING : floorNo;
        this.blockNo = blockNo == null ? EMPTY_STRING : blockNo;
        this.streetCode = "";
    ...
    private String getAddressType(String inputType) {
        ...
        if (inputType == null || inputType.trim().isEmpty()) {
            return MhaAddressTypeEnum.OVERSEAS_ADDRESS.getValue();
        }
