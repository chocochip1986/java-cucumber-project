...
public interface PropertyDetailRepo extends JpaRepository<PropertyDetail, Long> {
    ...
    List<PropertyDetail> findByAddress(String unit, String blockNo, String floor, String buildingName, String streetName, String streetCode, String postalCode, String newPostalCode);
